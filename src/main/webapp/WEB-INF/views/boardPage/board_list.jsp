...
<input type="hidden" id="page" value="${pagination.page }">
	...
	<div class="container" style="margin-top: 50px">
				...
				<c:otherwise>
					...
					<c:forEach items="${board_list }" var="boardDto">
						<tr>
							...
							<td><a href="/board/${category}/${boardDto.board_no }">${boardDto.board_title }</a></td>
							<td align="right">${boardDto.board_writer }</td>
							<td align="right">${boardDto.board_regDate }</td>
						</tr>
					</c:forEach>		
				</c:otherwise>
			</c:choose>
		...
		<div style="float: right">
					<a href="/board/${category }/insert" class="btn btn-primary">글쓰기</a>
		</div>
		<div>
